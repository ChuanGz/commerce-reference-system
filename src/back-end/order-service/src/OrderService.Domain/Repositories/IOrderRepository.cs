...
public interface IOrderRepository
{
    ...
    Task<List<Order>> GetByStatusAsync(string status, CancellationToken cancellationToken = default);
    ...
    Task<bool> AnyAsync(Expression<Func<Order, bool>> predicate, CancellationToken cancellationToken = default);
}
